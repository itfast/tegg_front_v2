...
export const CardAddress = ({
    ...
    api.client
      ...
      .then((res) => {
        ...
        setAddress({
          ...
          document:
            (res.data.Cpf && documentFormat(res.data.Cpf)) ||
            (res.data.Cnpj && documentFormat(res.data.Cnpj)),
          name: res.data.Name,
  ...
  useEffect(() => {
    ...
    if (api.currentUser.AccessTypes[0] !== 'TEGG') {
      api.iccid.getSubscriptions(1, 100).then((res) => {
    ...
    <div style={{ width: window.innerWidth < 768 && '100%' }}>
      <div>
        ...
        <InputDataCard
          style={{
            ...
            marginTop: window.innerWidth < 769 && 5,
          }}
          type='text'
          id='address'
      ...
      >
        ...
        <InputDataCard
          ...
          value={address.city}
          style={{
            marginRight: window.innerWidth > 768 && 5,
            marginLeft: window.innerWidth > 768 && 5,
            marginTop: window.innerWidth < 769 && 5,
            marginBottom: window.innerWidth < 769 && 5,
          }}
