...
tr:nth-child(even) {background-color: #d1f7d5;}
tr:first-child{
...
export const TypeContainer = styled.div`
	...
	margin: 1rem;
	border-radius: 8px;
	border: ${(props) => props.disabled? '2px solid #ccc' : `2px solid ${props.theme.colors.button}`};
	/* border: 2px solid ${({ theme }) => theme.colors.button}; */
	justify-content: center;
	align-items: center;
	color: ${(props) => (props.disabled ? "#9e9e9e" :props.selected ? "#fff" : "#000")};
	background-color: ${(props) => (props.disabled? '#ccc' :props.selected ? "#00D959" : "#fff")};
`;