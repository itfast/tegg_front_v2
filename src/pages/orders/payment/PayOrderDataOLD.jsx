...
export const PayOrderData = ({ order, goBackStep, label }) => {
	...
	const handleNext = () => {
		if (paymentMethod !== "") {
			if (paymentMethod == "CREDITO") {
				navigate(`/orders/pay/credit/${order}`);
			} else {
				navigate(`/orders/pay/pix/${order}`);
			}
		} else {
	...
	return (
		<CardData>
			...
			<div className="input_row_3">
				<div className="tb">
					<label className="bold">ITENS DO PEDIDO</label>
					<table>
						<tr>
							<th>Nome</th>
							<th>Preço</th>
			...
			<div className="input_row_3">
				<div className="input_3">
					<label className="bold">FORMA DE PAGAMENTO</label>
					<SelectUfs
						name="UF3"
						id="UF3"
