...
import { cepFormat, translateError, translateValue } from '../../../services/util'
    ...
    <div>
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        ...
        >
          ...
          <Typography sx={{ color: 'text.secondary' }}>{selectedClient?.label || selectedResaleBuying?.label }</Typography>
        </AccordionSummary>
        <AccordionDetails>
