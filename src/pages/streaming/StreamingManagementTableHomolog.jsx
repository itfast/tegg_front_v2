...
export const StreamingManagementTableHomolog = ({
  setLoading,
  setMsg,
  stream,
  search,
  ...
  return (
    <>
      <tr>
        ...
        <td>{stream?.Document ? documentFormat(stream.Document) : ""}</td>
        <td>
          {stream?.PlayHubSubscriptions?.map((s) => (
            <h5 key={s.PlayHubId}>{s.PlayHubId}</h5>
          ))}
        </td>

        <td>
          <div>
            {stream?.PlayHubSubscriptions?.map((p) => (
              <h5 key={p.Id}>{moment(p.CreatedAt).format("DD/MM/YYYY")}</h5>
            ))}
          </div>
        </td>
        <td>
          ...
          >
            <div>
              {stream?.PlayHubSubscriptions?.map((p) => (
                <h5 key={p.Id}>{moment(p.EndDate).format("DD/MM/YYYY")}</h5>
              ))}
            </div>
            <div>
              <IconButton
          ...
          <DialogContentText id="alert-dialog-description">
            ...
            <div style={{ width: "100%" }}>
              ...
              <InputData
                ...
                value={qtdStandard}
                style={{ width: "100%" }}
                onChange={(e) => setQtdStandard(e.target.value)}
              />
            </div>
            <div style={{ width: "100%" }}>
              ...
              <InputData
                ...
                value={qtdPremium}
                style={{ width: "100%" }}
                onChange={(e) => setQtdPremium(e.target.value)}
              />
            </div>
            {/* </div> */}
          </DialogContentText>
      ...
      <Dialog
        ...
        aria-describedby="alert-dialog-description"
      >
        <DialogTitle id="alert-dialog-title">{t("StreamingManager.table.modal.titleEdit")}</DialogTitle>
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            <div style={{ width: "100%", display: "flex", gap: 10 }}>
              ...
              <div style={{ width: "100%" }}>
                <h5>C{t("StreamingManager.phoneInput")}</h5>
                <InputData
                  value={phone}
                  style={{ width: "100%" }}
